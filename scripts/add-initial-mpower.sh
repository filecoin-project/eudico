...
EUDICO_PATH=$PWD/data/alice ./eudico send --from t1d2xrzcslx7xlbbylc5c3d5lvandqw4iwl6epxba --method 4 --params-json "{\"PubKey\":[\"1\", \"0\", \"1\"]}" t065 0
EUDICO_PATH=$PWD/data/alice ./eudico send --from t1d2xrzcslx7xlbbylc5c3d5lvandqw4iwl6epxba --method 4 --params-json "[0, 0, 1]" t065 0