...
import (
	...
	registry "github.com/filecoin-project/lotus/chain/consensus/actors/registry"
...
func (s *ServicesImpl) DecodeTypedParamsFromJSON(ctx context.Context, to address.Address, method abi.MethodNum, paramstr string) ([]byte, error) {
	...
	methodMeta, found := registry.NewActorRegistry().Methods[act.Code][method] // TODO: use remote map
	if !found {
