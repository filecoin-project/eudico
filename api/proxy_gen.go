...
type HierarchicalCnsStruct struct {
	Internal struct {
		...
		AddSubnet func(p0 context.Context, p1 address.Address, p2 address.SubnetID, p3 string, p4 uint64, p5 abi.TokenAmount, p6 abi.ChainEpoch, p7 abi.ChainEpoch, p8 *hierarchical.ConsensusParams) (address.Address, error) `perm:"write"`
...
func (s *HierarchicalCnsStruct) AddSubnet(p0 context.Context, p1 address.Address, p2 address.SubnetID, p3 string, p4 uint64, p5 abi.TokenAmount, p6 abi.ChainEpoch, p7 abi.ChainEpoch, p8 *hierarchical.ConsensusParams) (address.Address, error) {
	if s.Internal.AddSubnet == nil {
		return *new(address.Address), ErrNotSupported
	}
	return s.Internal.AddSubnet(p0, p1, p2, p3, p4, p5, p6, p7, p8)
}

func (s *HierarchicalCnsStub) AddSubnet(p0 context.Context, p1 address.Address, p2 address.SubnetID, p3 string, p4 uint64, p5 abi.TokenAmount, p6 abi.ChainEpoch, p7 abi.ChainEpoch, p8 *hierarchical.ConsensusParams) (address.Address, error) {
	return *new(address.Address), ErrNotSupported
}
...
func (s *HierarchicalCnsStruct) ListSubnets(p0 context.Context, p1 address.SubnetID) ([]sca.SubnetOutput, error) {
...
func (s *HierarchicalCnsStub) ListSubnets(p0 context.Context, p1 address.SubnetID) ([]sca.SubnetOutput, error) {
	return *new([]sca.SubnetOutput), ErrNotSupported
}
