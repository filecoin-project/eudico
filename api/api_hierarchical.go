...
type HierarchicalCns interface {
	...
	GetCrossMsgsPool(ctx context.Context, id hierarchical.SubnetID, height abi.ChainEpoch) ([]*types.Message, error)            // perm:read
	...
	ReleaseFunds(ctx context.Context, wallet address.Address, id hierarchical.SubnetID, value abi.TokenAmount) (cid.Cid, error) // perm:write
}
